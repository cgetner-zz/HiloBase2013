...
module ActiveMerchant #:nodoc:
  module Billing #:nodoc:
    module Integrations #:nodoc:
      module Dwolla 
        autoload :Return, 'active_merchant/active_merchant/billing/integrations/dwolla/return.rb'
        autoload :Helper, 'active_merchant/active_merchant/billing/integrations/dwolla/helper.rb'
        autoload :Notification, 'active_merchant/active_merchant/billing/integrations/dwolla/notification.rb'
